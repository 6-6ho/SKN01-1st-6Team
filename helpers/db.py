...
# 엑셀 파일 경로
region_table_xlsx_file_path = r"C:\Users\minkw\Desktop\workspace01\crawling_project\data\region_table.xlsx"
df_region = pd.read_excel(region_table_xlsx_file_path, engine="openpyxl")

car_table_xlsx_file_path = r"C:\Users\minkw\Desktop\workspace01\crawling_project\data\car_table.xlsx"
df_car = pd.read_excel(car_table_xlsx_file_path, engine="openpyxl")

van_table_xlsx_file_path = r"C:\Users\minkw\Desktop\workspace01\crawling_project\data\van_table.xlsx"
df_van = pd.read_excel(van_table_xlsx_file_path, engine="openpyxl")

truck_table_xlsx_file_path = r"C:\Users\minkw\Desktop\workspace01\crawling_project\data\truck_table.xlsx"
...
df_special_vehicle = pd.read_excel(special_vehicle_table_xlsx_file_path, engine="openpyxl")

faq_data_xlsx_file_path = r"C:\Users\minkw\Desktop\workspace01\crawling_project\data\faq_data.xlsx"
...
try:
    with engine.connect() as connection:        
        ...
        connection.execute(text("DROP TABLE IF EXISTS car, van, truck, special_vehicle;"))
        ...
        # 데이터 삽입 시도
        df_region.to_sql("region", con=engine, index=False, if_exists="append", method="multi")
        df_car.to_sql("car", con=engine, index=False, if_exists="append", method="multi")
        df_van.to_sql("van", con=engine, index=False, if_exists="append", method="multi")
        df_truck.to_sql("truck", con=engine, index=False, if_exists="append", method="multi")
        df_special_vehicle.to_sql("special_vehicle", con=engine, index=False, if_exists="append", method="multi")
